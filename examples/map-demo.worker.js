// examples/map-demo.worker.js â€” offload extractGrid + gridToImageData.
//
...
//
// extractGrid runs inline here (workers: 0) â€” this worker is already off the
...
self.onmessage = async (e) => {
  ...
  try {
    ...
    // Reproject equirectangular rows â†’ Web-Mercator so the raster lines up with
    ...
    // Hand back the PRE-warp grid too: transects need evenly spaced latitude rows.
