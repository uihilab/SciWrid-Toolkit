...
export async function grib2RangePointExtract(url, query, opts = {}) {
  return _fromReader(new GrbRangeReader(url, { fetchImpl: opts.fetchImpl }), query);
}
...
export async function grib2RangePointExtractFile(path, query, opts = {}) {
  ...
  try { return await _fromReader(reader, query); }
  finally { reader.close(); }
}

async function _fromReader(reader, query) {
  try {
