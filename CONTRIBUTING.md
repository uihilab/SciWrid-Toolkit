# Contributing to webparsers

## Toolchain at a glance

webparsers is a **JavaScript/TypeScript library** with a small C core compiled
to WebAssembly. The compiled `wasm/webparsers.wasm` is committed, so day-to-day
...
`test:slim`, `test:grid`, `test:render`, `test:time`, `test:kerchunk`, ... (see
...
Commit the regenerated `wasm/webparsers.wasm` so other contributors and the
